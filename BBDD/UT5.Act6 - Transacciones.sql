...
VALUES (1001, 'Carlos', 'Lopez', 'Cortéz', 5748, 'carloslopez@almeria.es', 'ALM-ES', 1234124, 'Representante de ventas');
SAVEPOINT empleado;
INSERT INTO cliente(codigo_cliente, nombre_cliente, nombre_contacto, apellido_contacto, telefono, linea_direccion1, ciudad, region, pais, codigo_postal)
VALUES (5001, 'Frutas MJ', 'Camilo', 'Jiemenez', 8738738, 'Calle Pingüino Cojo, 132', 'Almería', 'Europa', 'España', NULL);
COMMIT;
